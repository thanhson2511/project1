            ...
            <?php 
              ...
              <tr>
                ...
                <td><?php echo $category['description'] ?></td>
                  ...
                  <td>
                      <a href="index.php?mod=category&act=detail&id=<?=$category['id']?>" class="btn btn-primary">Detail</a>
                      <a href="index.php?mod=category&act=edit&id=<?=$category['id']?>" class="btn btn-success">Edit</a>
                      <a href="index.php?mod=category&act=destroy&id=<?=$category['id']?>" class="btn btn-danger">Delete</a>
                   </td>
                </tr>
       <?php } ?>
   </table>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="Views/auth/login.php">Logout</a>
        </div>
      </div>
    </div>
  </div>
